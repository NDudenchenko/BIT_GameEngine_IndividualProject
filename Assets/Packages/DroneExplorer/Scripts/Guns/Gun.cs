        ...
        void Update()
        {
            ...
            if (shoot && refireCur <= 0)
            {
                ...
                if (pool != null)
                {
                    ...
                    //Transform projectileTransform = new Transform(transform.position, transform.parent.rotation, transform.localScale);
                    pool.Shoot(transform.parent, team, speed, lifeTime, dammage, spray);
                }
            }
